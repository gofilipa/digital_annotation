 ...
 */
    ...
    // selects the adder element
    this.element

      // searches for the HIGHLIGHT_BTN_SELECTOR
      .querySelector(HIGHLIGHT_BTN_SELECTOR)

      // adds an event listener to that selector
      .addEventListener('click', event =>

        // function called by event with option onHighlight
